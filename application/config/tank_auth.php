...
|--------------------------------------------------------------------------
*/
$config['website_name'] = 'eFormation';
$config['webmaster_email'] = 'admin@eformation.com';
...
$config['recaptcha_public_key'] = '6LdObNwSAAAAACPTf7yKCq7js2H8JKnsEb11r10s';
$config['recaptcha_private_key'] = '6LdObNwSAAAAAEVbtLRCo-QEJyUQjWsTrjuCNDHE';
