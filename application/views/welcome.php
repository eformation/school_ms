...
<head>
<title>eFormation - School Management System</title>
		...
		<header>
			<div id="header">
				<section class="section_top">
					<div class="inner">
						<div id="logo"><a href="./"><img src="images/logo.png" alt="SkyDream" title="SkyDream" /></a></div>
						
						<nav class="main_menu">
							<ul>
								<li class="current_page_item"><a href="index.html">Home<span class="subtext">start here</span></a>
									
									<ul>
										<li><a href="./">Home Page Style 1</a></li>
									...
									<ul>
                                                                            <li><a href="admission_dashboard.html">Admission Dashboard</a></li>
                                                                            <li><a href="new_admission.html">New Admission</a></li>
                                                                        </ul>
                                                                </li>
							<!--	<li><a href="#">Our Projects<span class="subtext">result of our work</span></a>
									...
									<ul>
										...
										<li><a href="portfolio_2_1_c.html">Portfolio Style 2</a>
										...
										<li><a href="portfolio_3_1_c.html">Portfolio Style 3</a>
				...
				<section class="section_slider_1">
					...
					<div id="slider" class="slider">
						<div class="oneByOne_item">
							<img src="images/pic_slider_1_1_1.png" alt="" class="pic_1_1" data-ease-type="bounceInRight" />
							<img src="images/pic_slider_1_1_2.png" alt="" class="pic_1_2" data-ease-type="bounceInRight" />
							<img src="images/pic_slider_1_1_3.png" alt="" class="pic_1_3" data-ease-type="bounceInRight" />
						...
						<div class="oneByOne_item">
							<img src="images/pic_slider_1_2_1.png" alt="" class="pic_2_1" data-ease-type="fadeInRight" />
							<img src="images/pic_slider_1_2_2.png" alt="" class="pic_2_2" data-ease-type="fadeInRight" />
						...
						<div class="oneByOne_item">
							<img src="images/pic_slider_1_3_1.png" alt="" class="pic_3_1" data-ease-type="bounceInDown" />
							<img src="images/pic_slider_1_3_2.png" alt="" class="pic_3_2" data-ease-type="bounceInDown" />
							<img src="images/pic_slider_1_3_3.png" alt="" class="pic_3_3" data-ease-type="bounceInDown" />
				...
				<div class="general_content">
					<div class="main_content">
						...
						<div class="block_services_type_1">
							<div class="service">
								<div class="icon"><img src="images/icon_services_1_1.png" alt="" /></div>
								<div class="title">
								...
								<div class="text">
									...
									<a href="services.html" class="general_button fr">Read More</a>
								</div>
							</div>
							
							<div class="service">
								<div class="icon"><img src="images/icon_services_1_2.png" alt="" /></div>
								<div class="title">
							...
							<div class="service">
								<div class="icon"><img src="images/icon_services_1_3.png" alt="" /></div>
								<div class="title">
						...
						<div class="block_latest_projects_2">
							...
							<div class="project">
								<div class="image">
									<img src="images/pic_latest_project_2_1.jpg" alt="" />
									<div class="info">
										<div class="icons">
											<ul>
												<li><a href="images/pic_latest_project_2_1.jpg" data-rel="prettyPhoto" class="icon_zoom" title="">Zoom</a></li>
								...
								<div class="description">
									<h6><a href="portfolio_item.html">Biometric Enrollment & Login</a></h6>
							...
							<div class="project">
								<div class="image">
									<img src="images/pic_latest_project_2_2.jpg" alt="" />
									<div class="info">
										<div class="icons">
											<ul>
												<li><a href="images/pic_latest_project_2_2.jpg" data-rel="prettyPhoto" class="icon_zoom" title="">Zoom</a></li>
												<li><a href="portfolio_item.html" class="icon_link">Link</a></li>
											</ul>
										</div>
									</div>
								...
								<div class="description">
									<h6><a href="portfolio_item.html">Quick SMS alert on login</a></h6>
							...
							<div class="project">
								<div class="image">
									<img src="images/pic_latest_project_2_3.jpg" alt="" />
									<div class="info">
										<div class="icons">
											<ul>
												<li><a href="images/pic_latest_project_2_3.jpg" data-rel="prettyPhoto" class="icon_zoom" title="">Zoom</a></li>
												<li><a href="portfolio_item.html" class="icon_link">Link</a></li>
											</ul>
										</div>
									</div>
								...
								<div class="description">
									<h6><a href="portfolio_item.html">Centralized Web Portal</a></h6>
						...
						<div class="general_column_300">
							<div class="block_main_testimonials_2">
								...
								<div class="block_testimonials_3">
									<div class="userpic"><a href="#" style="background-image:url(images/pic_testimonials_3_1.jpg);"></a></div>
									<div class="content">
								...
								<div class="block_testimonials_3">
									<div class="userpic"><a href="#" style="background-image:url(images/pic_testimonials_3_2.jpg);"></a></div>
									<div class="content">
